...
<div class="row" style="margin-top:1.5em;">
	...
	<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
		<div class="form-group">
			...
			{!!Form::select('generales[medio_por_enterado]',array('0'=>'Mercado Libre','1'=>'Facebook','2'=>'Seminuevos.com','3'=>'Piso', '4'=>'Cambaceo','5' =>'Recomendado','6'=>'Pagina WEB','7'=>'Otro'),$prospeccion["generales"]["medio_por_enterado"],['class'=>'form-control','id'=>'generales_medio_por_enterado'])!!}
		</div>
	</div>
	<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
		<div class="form-group">
			<label for="">Toma de Desición</label>	
			{!!Form::select('generales[tomador_desicion]',array('0'=>'Tomador de Desición ','1'=>'Sub-tomador de Desición ','2'=>'Desición Compartida'),$prospeccion["generales"]["tomador_desicion"],['class'=>'form-control','id'=>'generales_tomador_desicion'])!!}
			</div>
	</div>
</div>
...
<div class="row" style="margin-top:1.5em;">
	<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
		...
		<div class="label_check" > 
			<input type="radio" class="check credito_pivot" name="credito[credito_pivot]" id="si_credito" value="true" {{($prospeccion["credito"]["credito_pivot"]=='true')? 'checked':'' }} ></div> &nbsp;  <label>Contado:</label>
		<div class="label_check" >
			<input type="radio" class="check credito_pivot" name="credito[credito_pivot]" id="no_credito" value="false" {{($prospeccion["credito"]["credito_pivot"]=='false')? 'checked':'' }} > 
...
<br>
<div  id="perfilCrediticio" style="{{($prospeccion["credito"]["credito_pivot"]=='false')? 'display:none;	':'' }}">
	<div class="row" >
		<div class="col-md-1 col-xs-3 col-sm-1 col-lg-1">
			<div class="form-group">
				<label for="">Plazo:</label>
				{!!Form::select('credito[plazo]',array('12'=>'12','24'=>'24','36'=>'36','48'=>'48','60'=>'60'),$prospeccion["credito"]["plazo"],['class'=>'form-control','id'=>'credito_plazo'])!!}
			</div>
		</div>
		<div class="col-md-3 col-xs-9 col-sm-3 col-lg-3">
			<div class="form-group">
				<label for="">Credito:</label>
				{!!Form::select('credito[credito]',array('0'=>'Credito Casa','1'=>'Credito Fondeadora'),$prospeccion["credito"]["credito"],['class'=>'form-control','id'=>'credito_tipo_credito'])!!}
			</div>
		</div>
		...
		<div class="col-md-1 col-sm-1 col-lg-1 col-xs-12">
			<div class="form-group">
				...
				{!!Form::number('credito[edad_cliente]',$prospeccion["credito"]["edad_cliente"],['class'=>'form-control','id'=>'credito_edad_cliente'])!!}
			</div>
		</div>
		<div class="col-md-4 col-sm-4 col-lg-4 col-xs-12">
			<div class="form-group">
				<label for="">Estado Buro de Credito:</label>
				{!!Form::select('credito[estado_buro]',array('Mal Buro','Buen Buro','No tiene Historial de Credito','Buro Regular'),$prospeccion["credito"]["estado_buro"],['class'=>'form-control'])!!}
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
			<div class="form-group">
				...
				{!!Form::select('credito[comprobante_ingresos]',['Declaraciones','Recibos de Nomina','Estados de Cuenta'],$prospeccion["credito"]["comprobante_ingresos"],['class'=>'form-control','id'=>'credito_comprobante_ingresos'])!!}
			</div>
		</div>
		<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12" id="numero_seguro_social" style="{{($prospeccion["credito"]["comprobante_ingresos"]=="1")? '':'display:none;' }}">
			<div class="form-group">
				<label for="">Numero Seguro Social:</label>
				{!!Form::number('credito[seguro_social]',$prospeccion["credito"]["seguro_social"],['class'=>'form-control','id'=>'credito_seguro_social'])!!}
			</div>
		</div>
		<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12" id="depositos_mensuales" style="{{($prospeccion["credito"]["comprobante_ingresos"]=="2")? '':'display:none;' }}">
			<div class="form-group">
				<label for="">Depositos Edo. de Cuenta:</label>
				{!!Form::number('credito[depositos_estados_cuenta]',$prospeccion["credito"]["depositos_estados_cuenta"],['class'=>'form-control','id'=>'credito_depositos_estados_cuenta'])!!}
			</div>
		</div>
</div>
</div>
...
<div class="row" style="margin-top:1.5em;">
	<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
		...
		Si
		<div class="label_check" > 
			<input type="radio" class="check check_vehiculo_cuenta" name="check_vehiculo_cuenta" id="si_credito" value="true"  {{($prospeccion["vehiculo_cuenta"]["check_vehiculo_cuenta"]=='true')? 'checked':'' }} >
		</div> &nbsp; No 
		<div class="label_check" >
			<input type="radio" class="check check_vehiculo_cuenta" name="check_vehiculo_cuenta" id="no_credito" value="false" {{($prospeccion["vehiculo_cuenta"]["check_vehiculo_cuenta"]=='false')? 'checked':'' }} > 
		</div>
	</div>
...
<div  id="vehiculo_a_cuenta" style="{{($prospeccion["vehiculo_cuenta"]["check_vehiculo_cuenta"]=='false')? 'display:none;':'' }} margin-top:1.5em;">
<div class="row">
	<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
		<div class="form-group">
	...
	<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12">
		<div class="form-group">
			<label for="">Papeles:</label>
				{!!Form::select('vehiculo_cuenta[papeles]',['Factura de  Agencia','Arrendadora','Empresa','Lote','Asseguradora'],$prospeccion["vehiculo_cuenta"]["papeles"],['class'=>'form-control','id'=>'vehiculo_cuenta_papeles'])!!}
		</div>	
...
@endforeach
	...
	<div class="form-group" >
			...
			<button style="margin-top:1.5em;" class="btn btn-dark" onclick="nuevafecha(event);">Nueva fecha</button>
		</div>
	</div>
</div>
<div class="row" style="margin-top:6em;">
