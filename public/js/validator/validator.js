...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Es necesario seleccionar',
        empty           : 'Por favor inserta los datos',
        min             : 'Contenido muy corto',
        max             : 'Contenido muy largo',
        number_min      : 'minimo',
        number_max      : 'maximo',
        url             : 'URL invalido',
        number          : 'No es un Numero',
        email           : 'Direccion email invalida',
        email_repeat    : 'Las direcciones no coinciden',
        password_repeat : 'Contraseñas no coinciden',
        repeat          : 'No coinciden',
        complete        : 'Datos incompletos',
        select          : 'Por Favor elige una opcion'
    };
